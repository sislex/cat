...
@section('page_bar')
    ...
    <h3 class="page-title"> Спецификации
        ...
        <a href="{{action('Admin\SpecificationsController@add')}}" class="btn btn-outline btn-circle btn green pull-right">
                                                    ...
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th>
                                                                ...
                                                                <a href="{{action('Admin\SpecificationsController@specification', ['id' => $spec_group['name']])}}" class="btn btn-outline btn-circle btn-sm purple">
